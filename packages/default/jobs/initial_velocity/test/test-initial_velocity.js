/**
 * Test file for Job: initial_velocity
 */

var assert = require ('assert');
var initial_velocity_SUT = require('../initial_velocity');

var mockedConfig, mockedDependencies;

describe ('initial_velocity test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      initial_velocity_SUT.onRun(config, mockedDependencies, function(err, data){
