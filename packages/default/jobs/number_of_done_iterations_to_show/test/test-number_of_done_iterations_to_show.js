/**
 * Test file for Job: number_of_done_iterations_to_show
 */

var assert = require ('assert');
var number_of_done_iterations_to_show_SUT = require('../number_of_done_iterations_to_show');

var mockedConfig, mockedDependencies;

describe ('number_of_done_iterations_to_show test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      number_of_done_iterations_to_show_SUT.onRun(config, mockedDependencies, function(err, data){
