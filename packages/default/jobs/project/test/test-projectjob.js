/**
 * Test file for Job: projectjob
 */

var assert = require ('assert');
var projectjob_SUT = require('../projectjob');

var mockedConfig, mockedDependencies;

describe ('projectjob test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      projectjob_SUT.onRun(config, mockedDependencies, function(err, data){
